...
## [3.88.0-beta.0](https://github.com/filpgame/picpeak/compare/v3.87.0-beta.0...v3.88.0-beta.0) (2026-07-14)
...
* admin photos list/grid toggle + upload failure report ([#707](https://github.com/filpgame/picpeak/issues/707), [#708](https://github.com/filpgame/picpeak/issues/708)) ([e873f7c](https://github.com/filpgame/picpeak/commit/e873f7c98ce108b090d70a3b7df2d2929699e997))
* admin photos list/grid toggle + upload failure report ([#707](https://github.com/filpgame/picpeak/issues/707), [#708](https://github.com/filpgame/picpeak/issues/708)) ([6f95796](https://github.com/filpgame/picpeak/commit/6f95796b7c19829197eaff0d4934ad9b84d0e2f3))
* admin two-factor authentication (TOTP) with recovery codes + CLI reset ([cf07361](https://github.com/filpgame/picpeak/commit/cf073615effa8a91e19374ad3e9924e6e7322950))
* admin-configurable workflow engine + dunning/Mahngebühr rework (RFC — feedback welcome) ([15be3b8](https://github.com/filpgame/picpeak/commit/15be3b8d32965eedc08d46ccc525c65a3bf34de6))
* **admin-ui:** TOTP MFA enrollment + two-step login; remove stub 2FA toggle ([96e3c68](https://github.com/filpgame/picpeak/commit/96e3c68b9d6b35a82abcad664a6da7b19150b4fd))
...
* **admin:** GitHub repo button in the sidebar footer ([#778](https://github.com/filpgame/picpeak/issues/778)) ([279e047](https://github.com/filpgame/picpeak/commit/279e0472c71c6a37ba091a9c7a31f5571c0a8df6))
* **admin:** GitHub repo button in the sidebar footer ([#778](https://github.com/filpgame/picpeak/issues/778)) ([d3d7df4](https://github.com/filpgame/picpeak/commit/d3d7df46f214028ba89063079d356bc0430083f5))
* **admin:** in-app migration banner for the org rename ([0213347](https://github.com/filpgame/picpeak/commit/02133478bd2684c562d11cc122cf5059832ff76a))
* **admin:** in-app migration banner for the org rename ([#669](https://github.com/filpgame/picpeak/issues/669)) ([2a4bf3b](https://github.com/filpgame/picpeak/commit/2a4bf3b868c6733d0b865c8c0e977ba84d6e6453))
* **analytics:** pluggable trackers — Umami + Rybbit + Custom ([#663](https://github.com/filpgame/picpeak/issues/663) Phase 1) ([83461fe](https://github.com/filpgame/picpeak/commit/83461fe5d4d44006482167464d92e70546cf7377))
* **analytics:** pluggable trackers — Umami + Rybbit + Custom ([#663](https://github.com/filpgame/picpeak/issues/663) Phase 1) ([ab50145](https://github.com/filpgame/picpeak/commit/ab501459a4208c3a30637a31f0f6f31285ae5ef2))
* **auth:** admin TOTP MFA — enrollment, login challenge, recovery, CLI reset ([72e2ef6](https://github.com/filpgame/picpeak/commit/72e2ef6721b0572ed34455de901aa357eacd8c76))
* **backup:** .picpeak download + upload-restore UI in Backup Manager ([66d61c8](https://github.com/filpgame/picpeak/commit/66d61c87cad1ac1994d61e81c8c06739aa0cb8c5))
* **backup:** .picpeak import/restore (full override, keeps current account) ([2920d82](https://github.com/filpgame/picpeak/commit/2920d82186d16d43674703d09370aeecec6a0da0))
* **backup:** .picpeak portable export (engine-neutral logical snapshot) ([38b3aef](https://github.com/filpgame/picpeak/commit/38b3aef63d0d4f0878eddeb93f16319ef87f2372))
* **backup:** fold .picpeak restore into the Restore wizard's Upload source ([86324e7](https://github.com/filpgame/picpeak/commit/86324e7da75069e61686b1b77495f02c33b12e1a))
* **backup:** upload + restore endpoint for .picpeak ([2b66f6d](https://github.com/filpgame/picpeak/commit/2b66f6d889f94848202faf02116efa94ade9bd12))
...
* **categories:** per-event category ordering — global default + override ([#782](https://github.com/filpgame/picpeak/issues/782)) ([d51112e](https://github.com/filpgame/picpeak/commit/d51112e761d2fd83f1939841fbf4c05e625fc34d))
* **categories:** per-event category ordering — global default + override ([#782](https://github.com/filpgame/picpeak/issues/782)) ([4698402](https://github.com/filpgame/picpeak/commit/4698402b5493cfbdb1e2b6d81c6f58829e17a703))
...
* **crm:** 3-reminder dunning + flat/percent Mahngebühr on 2nd & 3rd + AGB notice ([dcdbeb9](https://github.com/filpgame/picpeak/commit/dcdbeb9cc50a888ff66e65c62597fcc84c2c8f17))
* **crm:** event-type dropdown on quotes; quote→event uses it (no more hardcoded 'wedding') ([f78671f](https://github.com/filpgame/picpeak/commit/f78671fc6c8d234be4dee87b45aae9d280a3a6f7))
* **crm:** Mahngebühr on a separate Mahnung document; invoice stays immutable ([5ed2fec](https://github.com/filpgame/picpeak/commit/5ed2fec2fe5cd5c2c8db6ea83c3b791313618e0f))
* **crm:** pre-event reminder falls back to the assigned customer account ([3ccaed0](https://github.com/filpgame/picpeak/commit/3ccaed06a226cdc4a18399f8daa9b2d420e3684b))
* **crm:** toggle for VAT on late fees (jurisdiction-dependent) ([eaceb7e](https://github.com/filpgame/picpeak/commit/eaceb7e71caa6466d8298c0fc84487f0f4af1dca))
* **dashboard:** revenue "year" tile toggles 365 days ↔ calendar YTD ([d1c9e02](https://github.com/filpgame/picpeak/commit/d1c9e02bcf50b6c08eebc85acdbfba29bfee84ac))
...
* **encryption:** secure gallery password resend ([#37](https://github.com/filpgame/picpeak/issues/37)) ([f782c03](https://github.com/filpgame/picpeak/commit/f782c03f2f4fb912dc97bd1c7b3a72c0a4413ea1))
...
* **feedback:** per-guest favorite + like caps with mobile-friendly limit modal ([#655](https://github.com/filpgame/picpeak/issues/655)) ([3ac7017](https://github.com/filpgame/picpeak/commit/3ac70177efc237b8169278208983b0de3629bc72))
* **feedback:** per-guest favorite + like caps with mobile-friendly limit modal ([#655](https://github.com/filpgame/picpeak/issues/655)) ([f2814e4](https://github.com/filpgame/picpeak/commit/f2814e4a4ce3aa9affc232243d615a15a1aae0c0))
* first-run setup wizard (feature selection + config) and portable .picpeak backup roundtrip ([e513e83](https://github.com/filpgame/picpeak/commit/e513e8345b73e37ebedc9c9ec09665ffc5773e23))
* **gallery:** branded URL shortener — /s/&lt;slug&gt; with OG injection ([#699](https://github.com/filpgame/picpeak/issues/699)) ([a0f7033](https://github.com/filpgame/picpeak/commit/a0f7033ffc812f92d56e2eac7bd2f498b95ef83b))
* **gallery:** branded URL shortener — /s/&lt;slug&gt; with OG injection ([#699](https://github.com/filpgame/picpeak/issues/699)) ([56c2386](https://github.com/filpgame/picpeak/commit/56c2386c90a090ee1e7f44a51328fc1291fe323f))
* **gallery:** publish notifies assigned customer accounts via the account email ([c657892](https://github.com/filpgame/picpeak/commit/c657892bc87f44e854827cb8a65f87cc528a2f71))
* **invoices:** configurable VAT note under MwSt. line + fix multi-page page-number overlap ([#794](https://github.com/filpgame/picpeak/issues/794)) ([ffd4a7e](https://github.com/filpgame/picpeak/commit/ffd4a7eee64b6418df1c9cc6843d86dc0f41d2ec))
* **invoices:** configurable VAT/free-text note + fix multi-page page-number overlap ([#794](https://github.com/filpgame/picpeak/issues/794)) ([1476884](https://github.com/filpgame/picpeak/commit/1476884dd04202f5f18d50d458b6176b0535c71b))
* **invoices:** optional sub-cent rounding reconciliation ("Rundung" row) ([4670292](https://github.com/filpgame/picpeak/commit/4670292139bf4c5ad523646f38b98b9d47ab3430))
* **invoices:** surface monthly/manual accumulator drafts in the Bills list ([e457656](https://github.com/filpgame/picpeak/commit/e457656b9d06bb420c9d0985fe15c30d6c88aed9))
...
* **messages:** create/select quote, contract, invoice, gallery from a message ([0dbf863](https://github.com/filpgame/picpeak/commit/0dbf863f60b919560b766f78b107ebac9612bd9d))
* **messages:** Outlook-style Messages email client (3 phases, flag-gated) ([d0bdcb1](https://github.com/filpgame/picpeak/commit/d0bdcb1a6afd0f227d468adc35c23bb88410a578))
* **messages:** Phase 1 read-only Messages viewer (email client shell) ([26eeb76](https://github.com/filpgame/picpeak/commit/26eeb7619703ffe0b29653e409beecd30263bcb0))
* **messages:** Phase 2 — customer (hello@) mailbox + inbound body capture ([ee46cf2](https://github.com/filpgame/picpeak/commit/ee46cf2125c2721c3cecee8761490652552a2f2a))
* **messages:** Phase 3 — editable-template composer, reply + create actions ([768e847](https://github.com/filpgame/picpeak/commit/768e84711f3362069d7ce6867e63c727d2009a46))
* **messages:** search bar + Archive/Delete with Archived & Deleted folders ([99d5996](https://github.com/filpgame/picpeak/commit/99d5996561a2dcff2d431692d5bab5c7286d1f6f))
* **messages:** unified Messages email client (flag-gated, default off) ([a71b9b5](https://github.com/filpgame/picpeak/commit/a71b9b5ed721df17b61062ae3a2361d448c95cf7))
* **projects:** flag re-rendered emails in the feed ([94f2c01](https://github.com/filpgame/picpeak/commit/94f2c01590d52962c565eea5d6f47444ff0d5782))
* **projects:** linking a quote/contract cascades the whole deal into the project ([a702f33](https://github.com/filpgame/picpeak/commit/a702f33004996ca53f77c9177cb50a6504410801))
...
* setup wizard + argument-driven unattended install ([681619f](https://github.com/filpgame/picpeak/commit/681619f0a14070309342a9f908a5bbc8a57d47d8))
* **setup:** add "How will you use PicPeak?" feature-selection step ([422dfe1](https://github.com/filpgame/picpeak/commit/422dfe1cc88ae277dc170e95b4746e507c31b23a))
* **setup:** add restore-from-backup branch to the first-run wizard ([a95ee47](https://github.com/filpgame/picpeak/commit/a95ee473ae7fb2bf3c94c610724476701145d113))
* **setup:** brand first-run screen and split into two-step wizard ([d9b0eb7](https://github.com/filpgame/picpeak/commit/d9b0eb723295c20e80c0e633ebcdb6e191528607))
* **setup:** final community step ([#732](https://github.com/filpgame/picpeak/issues/732)) + fix create-admin button overflow ([#730](https://github.com/filpgame/picpeak/issues/730)) ([a5f49e3](https://github.com/filpgame/picpeak/commit/a5f49e32350564ee4d3894f33e9611e9244cc994))
* **setup:** final community/thank-you step ([#732](https://github.com/filpgame/picpeak/issues/732)); fix create-admin button overflow ([#730](https://github.com/filpgame/picpeak/issues/730)) ([dadaaee](https://github.com/filpgame/picpeak/commit/dadaaeea7781cb62811256b512003e5c4d6ad95e))
* **setup:** per-feature config step after feature selection ([07b450a](https://github.com/filpgame/picpeak/commit/07b450a954a53781d23a71749552e4101c637777))
* **setup:** step-by-step wizard + argument-driven unattended install ([d35c413](https://github.com/filpgame/picpeak/commit/d35c413651bc10f177a683a8057ad92c03b1cf00))
* **setup:** validate setup token at step 1 before advancing ([b0912c7](https://github.com/filpgame/picpeak/commit/b0912c74276ad2489a8d199739d6eee2e8dabf53))
...
* **slideshow:** per-event play order + category filter ([#202](https://github.com/filpgame/picpeak/issues/202)) ([5467642](https://github.com/filpgame/picpeak/commit/54676424f2f7ed50e74cb8e144cbdaa5a96e65c3))
* **slideshow:** per-event play order + category filter ([#202](https://github.com/filpgame/picpeak/issues/202)) ([b768a53](https://github.com/filpgame/picpeak/commit/b768a53c5be577bf0ed537b0876090b3f1c4a32b))
...
* **updates:** "What's New" highlights after update + pre-update teaser ([a1a73bf](https://github.com/filpgame/picpeak/commit/a1a73bf75ff3fcd0833fdf7922a35ad09f19439b))
* **updates:** "What's New" highlights after update + pre-update teaser ([500cf85](https://github.com/filpgame/picpeak/commit/500cf8522e556575bd74d4c71d38a83fb2596b5e))
...
* **workflows:** 'Clean up layout' auto-arrange button (dagre) ([79607c5](https://github.com/filpgame/picpeak/commit/79607c597af07ca5b78a689469c3ffefc3699317))
* **workflows:** add workflows feature flag + Features-tab toggle ([ff47861](https://github.com/filpgame/picpeak/commit/ff478619b580096d4dfb46dd6ad751daead082fb))
* **workflows:** admin CRUD + run-history + approvals-inbox API ([1a0d6de](https://github.com/filpgame/picpeak/commit/1a0d6de04d3547ca0e34833befea200c2750e859))
* **workflows:** admin review gates before sends + migrate lifecycle/time triggers ([fa7b1ba](https://github.com/filpgame/picpeak/commit/fa7b1bae951222de506ab8a3c8aee158b471efd1))
* **workflows:** advanced text mode — export/import the flow as JSON ([289568f](https://github.com/filpgame/picpeak/commit/289568fd52fcf0f33a959f074d215853ae37e48c))
* **workflows:** approval gates — email confirm/deny + token resume ([b48d8c2](https://github.com/filpgame/picpeak/commit/b48d8c2eb8e278d3dad8a8afef221a640bcac919))
* **workflows:** booking cutover — wire booking actions + hold documents behind approval gates ([ec33ec7](https://github.com/filpgame/picpeak/commit/ec33ec7670a4feb1108d1bcbfe34727f63cc8cf9))
* **workflows:** collections-handoff block after dunning exhausts ([b78bd97](https://github.com/filpgame/picpeak/commit/b78bd979dc4856a78d2022783537b8efd1297d27))
* **workflows:** crash recovery — resume runs orphaned mid-flow ([192d2cb](https://github.com/filpgame/picpeak/commit/192d2cbc06a0295dbfdc35f05d192ae7ed5273e6))
* **workflows:** data-touching action + condition handlers ([96fb440](https://github.com/filpgame/picpeak/commit/96fb44045e49c4cbc9b221780f7c725f80751993))
* **workflows:** emit lifecycle events from invoice + quote services ([cc0ba53](https://github.com/filpgame/picpeak/commit/cc0ba5347d36161e3da2eaff3a1f2d56c582c4a5))
* **workflows:** execution engine core + registry + tests ([1eaef67](https://github.com/filpgame/picpeak/commit/1eaef67c36a1a1eae6d574d2d44f2a3bdfb43d4c))
* **workflows:** hard cutover of gallery-expiry + dunning + pre-event to flows ([0b6c33e](https://github.com/filpgame/picpeak/commit/0b6c33e59a2e1ba15210645a65800543eaf6305b))
* **workflows:** implement prepare_event so booking_full/booking_simple are enableable ([4faf5a3](https://github.com/filpgame/picpeak/commit/4faf5a344a8d6d03cd9f374e093cc9bd8317fa48))
* **workflows:** implement remaining stub actions (prepare_quote, prepare_gallery, reserve_date) ([9414b42](https://github.com/filpgame/picpeak/commit/9414b42b7fae9f5447c1879e9b2c34d05f7c888d))
* **workflows:** invoice prepared+approved early, dispatch waits; daysBefore in editor; dashboard approvals ([182e655](https://github.com/filpgame/picpeak/commit/182e655fcf0fa119714e6fd34cad5f33d0087045))
* **workflows:** make approval rows clickable to open the underlying document ([7727b67](https://github.com/filpgame/picpeak/commit/7727b6714b5654bab067b041ca9c33cf7d9270ab))
* **workflows:** migrate the dunning ladder onto the engine (cutover) ([5259ee9](https://github.com/filpgame/picpeak/commit/5259ee97053386a63e7bcdf2a5cae22842e5ceaa))
* **workflows:** per-quote booking-workflow picker + quote→invoice (no gallery) built-in ([d14f1d8](https://github.com/filpgame/picpeak/commit/d14f1d850cc995b2cb1119ba0424f123feba50ec))
* **workflows:** pre-event reminder picks the template GROUP on the block, type stays automatic ([10d091b](https://github.com/filpgame/picpeak/commit/10d091b55e0c44738b4001a71def6416a8f0aeb0))
* **workflows:** React Flow canvas editor + list + approvals UI ([5c0396d](https://github.com/filpgame/picpeak/commit/5c0396d0c1bf69ba48b42eacc6d8f145b901a299))
* **workflows:** route webhook node through the delivery pipeline (full Option 1) ([675e41a](https://github.com/filpgame/picpeak/commit/675e41a2f72c8c23fa5c36b13bc6b95abcb9d570))
* **workflows:** scheduler resumes elapsed wait nodes ([610a3df](https://github.com/filpgame/picpeak/commit/610a3dfd732fbf37c68bc3edacaed6c99610a2ab))
* **workflows:** schema + permissions (migration 142) ([c818c25](https://github.com/filpgame/picpeak/commit/c818c25cf2d7a9c9b281107a92528d5923758ab0))
* **workflows:** seed booking + pre-event built-ins, wire event.date_approaching ([62ba905](https://github.com/filpgame/picpeak/commit/62ba905464387784be7710610a65341569b68e46))
* **workflows:** seed invoice-dunning ladder as an editable built-in flow ([9b557ef](https://github.com/filpgame/picpeak/commit/9b557efbf347ba585ceac61cfc0b6b3038ef7de6))
* **workflows:** test-fire — safe dry-run of any flow on demand ([e70ddd3](https://github.com/filpgame/picpeak/commit/e70ddd36b8e9558dc44fc118277539fe6e7425d7))
* **workflows:** warn when disabling a built-in (reverts to legacy, not off) ([c5f131c](https://github.com/filpgame/picpeak/commit/c5f131cec32826331722ef3705c5f5422e31726d))
* **workflows:** wire booking document actions (prepare_invoice/contract + send_document) ([cf424ef](https://github.com/filpgame/picpeak/commit/cf424efb4a3a5e0df3a4bb1c753ca24368446816))
* zero-config first run — in-browser admin bootstrap + auto-generated secrets ([bafc96f](https://github.com/filpgame/picpeak/commit/bafc96f468e3b5cca2ec3291e7b568886755099d))
* zero-config first run — in-browser admin bootstrap + auto-generated secrets ([415bffa](https://github.com/filpgame/picpeak/commit/415bffa04cd82ea16c1803b67ee432a9ebd4165e))
...
* **admin/events:** delete cascade orphaned photo folders because it read a non-existent column ([#608](https://github.com/filpgame/picpeak/issues/608)) ([284680e](https://github.com/filpgame/picpeak/commit/284680e0357db20177e45ab4ab01de0fbcac2a98))
* **admin/events:** delete cascade orphaned photo folders because it read a non-existent column ([#608](https://github.com/filpgame/picpeak/issues/608)) ([457c956](https://github.com/filpgame/picpeak/commit/457c9563869156bc4773d873661a75d5115b25db))
...
* **admin:** graceful logo-img fallback + show sidebar widgets during perm hydration ([#523](https://github.com/filpgame/picpeak/issues/523) follow-up 2) ([f51b9cf](https://github.com/filpgame/picpeak/commit/f51b9cf8df2dfba07590b35cc63def689df98c4a))
* **admin:** logo-img fallback + sidebar perm hydration + filename NFD transliteration ([#523](https://github.com/filpgame/picpeak/issues/523) follow-up 2, [#607](https://github.com/filpgame/picpeak/issues/607)) ([fcd3ca3](https://github.com/filpgame/picpeak/commit/fcd3ca36c659eafa47c036f622da8114433b1c74))
* **admin:** stack publish-gallery dialog CTAs so the German label fits ([#670](https://github.com/filpgame/picpeak/issues/670)) ([748af98](https://github.com/filpgame/picpeak/commit/748af98f3d3f8c00695b82e94d741a0e10a39a81))
* **admin:** stack publish-gallery dialog CTAs so the German label fits ([#670](https://github.com/filpgame/picpeak/issues/670)) ([ea2852d](https://github.com/filpgame/picpeak/commit/ea2852dcb0a0f00318a2c8067405630bcff4eee6))
* **admin:** stop the event-date field crashing the page on backspace ([760a201](https://github.com/filpgame/picpeak/commit/760a201b6070a4edfe8192bcddce948c5f0c3fec))
* **admin:** stray literal "0" rendered from SQLite integer booleans ([760c3d7](https://github.com/filpgame/picpeak/commit/760c3d7b67963105f155a43297f165b7e672b074))
* **analytics:** admin dashboard reads correct fields + Umami device API ([#661](https://github.com/filpgame/picpeak/issues/661)) ([349f566](https://github.com/filpgame/picpeak/commit/349f566e87b33c59f61eb28b8abc5f889e6285d6))
* **analytics:** admin dashboard reads correct fields + Umami device API ([#661](https://github.com/filpgame/picpeak/issues/661)) ([7534447](https://github.com/filpgame/picpeak/commit/7534447b6c0df4290fd8dac12270673097096f1b))
...
* auto-publish release-please PRs without manual approval ([fb64ec0](https://github.com/filpgame/picpeak/commit/fb64ec0910f8c3ecffb40d85e4f3a08f73503671))
* **backup:** address .picpeak review — table filter, superuser guard, tests ([fa7665c](https://github.com/filpgame/picpeak/commit/fa7665c5b1ad18a4db4f0b59eb4c197a3c9a36e2))
* **backup:** make .picpeak roundtrip work on Postgres ([f57462f](https://github.com/filpgame/picpeak/commit/f57462f7984c64356a9f8acb63c7df3f93909e6e))
...
* **branding:** make 'Show logo in hero' a true global toggle with per-event override ([#756](https://github.com/filpgame/picpeak/issues/756)) ([a88da99](https://github.com/filpgame/picpeak/commit/a88da99c8d35c0c7cb7f96a235e984edad74ac7c))
* **branding:** make 'Show logo in hero' a true global toggle with per-event override ([#756](https://github.com/filpgame/picpeak/issues/756)) ([96fe478](https://github.com/filpgame/picpeak/commit/96fe478bf87a3350185206b3d6f15133138b995d))
...
* **branding:** unify hero logo SIZE the same way as visibility ([#756](https://github.com/filpgame/picpeak/issues/756)) ([60b03b1](https://github.com/filpgame/picpeak/commit/60b03b17287539b3ad5e5d32f4eda8622f0575e4))
...
* **categories:** address PR [#790](https://github.com/filpgame/picpeak/issues/790) review — event ownership, migration renumber, nits ([a4b4485](https://github.com/filpgame/picpeak/commit/a4b4485d322514690c5400ca7ab9a91bc25c3e48))
* **ci:** auto-publish release-please PRs without manual approval ([#719](https://github.com/filpgame/picpeak/issues/719)) ([a3e7232](https://github.com/filpgame/picpeak/commit/a3e7232b8ed012b8449a76d3e4ea3c5daddd5514))
* **ci:** enable release-PR auto-merge with the PAT, not GITHUB_TOKEN ([e08a33d](https://github.com/filpgame/picpeak/commit/e08a33d9ea273dc18877743f71f59d64bfc3dfb5))
* **ci:** publish v-prefixed image tags so :vX.Y.Z resolves ([#668](https://github.com/filpgame/picpeak/issues/668)) ([2ee4146](https://github.com/filpgame/picpeak/commit/2ee4146d9a6fd026e7b7be3ba774de9a0cf6e96a))
* **ci:** publish v-prefixed image tags so :vX.Y.Z resolves ([#668](https://github.com/filpgame/picpeak/issues/668)) ([784d059](https://github.com/filpgame/picpeak/commit/784d059c3da5b36e2b6794ebf2e34bc15c8a9824))
* **ci:** publish v-prefixed image tags via type=ref,event=tag ([#668](https://github.com/filpgame/picpeak/issues/668)) ([1f3bc3c](https://github.com/filpgame/picpeak/commit/1f3bc3c3430414b5b6cb2141d887a8b5855a04af))
* **ci:** publish v-prefixed image tags via type=ref,event=tag ([#668](https://github.com/filpgame/picpeak/issues/668)) ([39db7bf](https://github.com/filpgame/picpeak/commit/39db7bf6cb5c39fcdf71c875a4aaf704f34447fa))
* **ci:** set GH_REPO in release-please auto-merge step ([0cab43e](https://github.com/filpgame/picpeak/commit/0cab43ed898c0d080e946837894d676394805eb8))
* **ci:** whatsnew highlights — set GH_REPO so gh runs without a checkout ([3feed0f](https://github.com/filpgame/picpeak/commit/3feed0fae6a5792a7192a529942e08d9872b7e6e))
* **ci:** whatsnew highlights — set GH_REPO so gh runs without a checkout ([2a5f0a8](https://github.com/filpgame/picpeak/commit/2a5f0a8601ba5cb28243b39278ecdc0892388a96))
* conform moved code to eslint indent/quotes, 4-arg mutation callbacks ([2ea26a4](https://github.com/filpgame/picpeak/commit/2ea26a49620cbe0edfbccf219696b4b386ae50d0))
...
* **crm:** pre-event reminder passes raw event_date (fixes "Invalid Date" in the email) ([250b240](https://github.com/filpgame/picpeak/commit/250b240337733362cb9a74b248ac78b6e9347bf7))
* **crm:** pre-event reminder resolves recipient from the event row, not a non-existent column ([5fbe514](https://github.com/filpgame/picpeak/commit/5fbe514db6e386eee2eeade548bccbb5bbc5b422))
* **crm:** quote→event fallback resolves an ACTIVE event type, never hardcoded 'wedding' ([2309812](https://github.com/filpgame/picpeak/commit/23098127a83fb12f6a32809666ec93eef9ac90cb))
...
* **downloads:** transliterate accented characters in filename via NFD instead of dropping them ([#607](https://github.com/filpgame/picpeak/issues/607)) ([620163f](https://github.com/filpgame/picpeak/commit/620163f2db77cda40b81edcac79a32cbb4fd278f))
* **email,ui:** billing emails follow customer language + readable pay… ([ea86871](https://github.com/filpgame/picpeak/commit/ea86871b81ed65c47e0de3332510c9a0c8343ba0))
* **email,ui:** billing emails follow customer language + readable payment-check confirmation ([0c2d319](https://github.com/filpgame/picpeak/commit/0c2d319fc1ed67843cc60afdcaea5807ea49226f))
* **email,ui:** billing emails follow customer language + readable payment-check confirmation ([fcc3e91](https://github.com/filpgame/picpeak/commit/fcc3e9195d6f63b2dffddfa72a867a3e32325e81))
...
* **email:** resolve recipient language from the queue row's event_id, not just email_data ([10559fd](https://github.com/filpgame/picpeak/commit/10559fd68e77eb00f3dd79366fcbb7880321e6b8))
* **email:** sibling billing emails follow customer language too ([c0008be](https://github.com/filpgame/picpeak/commit/c0008be39bc8a9d354e48ce8d6bd89662bc53ebb))
* enable release-PR auto-merge with the PAT so releases actually publish ([97b9853](https://github.com/filpgame/picpeak/commit/97b9853709fb59a900d70bb2a6bf365d98ae4f86))
* event creation 500s on PostgreSQL (NaN slideshow seed) + stray "0" boolean renders ([b187f58](https://github.com/filpgame/picpeak/commit/b187f588b4d12af7a7849f8558c0085573d4af76))
* event-reminder, email-language & gallery-publish bugs surfaced during workflow testing ([c8714ca](https://github.com/filpgame/picpeak/commit/c8714ca42f4d82d50fe611b2a630260ebecbe740))
* **event-types:** renaming a type's slug cascades to events, quotes + reminder template ([415c93a](https://github.com/filpgame/picpeak/commit/415c93a512f74898d0225ce2e9298f24cc12f60d))
* **events:** NaN from slideshow seed breaks event creation on PostgreSQL ([8c86518](https://github.com/filpgame/picpeak/commit/8c86518aadae000f8e948b0cd6470730db549c1b))
...
* **events:** wire customer notifications into both public API entry points ([#647](https://github.com/filpgame/picpeak/issues/647)) ([f017542](https://github.com/filpgame/picpeak/commit/f01754247cdb94c5935ad5abbda116841f6c7fba))
* **events:** wire customer notifications into both public API entry points ([#647](https://github.com/filpgame/picpeak/issues/647)) ([511d647](https://github.com/filpgame/picpeak/commit/511d647eec656cd223c029a9455420fc0621cc80))
...
* **gallery:** guest upload honours general_max_files_per_upload + i18n placeholder interpolates ([#613](https://github.com/filpgame/picpeak/issues/613)) ([40a4aa2](https://github.com/filpgame/picpeak/commit/40a4aa2d85d93c9dc1faa69f0e6f8524ff917e29))
* **gallery:** guest upload honours general_max_files_per_upload + i18n placeholder interpolates ([#613](https://github.com/filpgame/picpeak/issues/613)) ([69b5186](https://github.com/filpgame/picpeak/commit/69b5186582d56c42cec520abbe5454171f9f666b))
...
* **gallery:** publish dialog stuck for password-protected galleries with no inline email ([aa3471e](https://github.com/filpgame/picpeak/commit/aa3471efe1629f36adeff8774dfdc379d4652e26))
* **gallery:** unbreak password entry in Instagram in-app browser ([#654](https://github.com/filpgame/picpeak/issues/654)) ([6193ab7](https://github.com/filpgame/picpeak/commit/6193ab7f6aafd94b6e2e432ddf170361fd306d4e))
* **gallery:** unbreak password entry in Instagram in-app browser ([#654](https://github.com/filpgame/picpeak/issues/654)) ([b1bfd48](https://github.com/filpgame/picpeak/commit/b1bfd4838e7104e4f85695e180b20222206073ac))
...
* **i18n:** replace ASCII quote with U+201D in DE perGuestLimitsDesc ([98e97e3](https://github.com/filpgame/picpeak/commit/98e97e3cf214c96cdefd99bfedd6724f0b85c41c))
...
* **invoices:** add bank transfer to the mark-paid method list ([e96ef4c](https://github.com/filpgame/picpeak/commit/e96ef4c5a35bc9e575bc3419fb318a3ee9df1bd6))
* **invoices:** badge held (unsent, no send date) invoices as "Draft" ([e4367e0](https://github.com/filpgame/picpeak/commit/e4367e028a5228ef50c4bbd522d0777bc7340b52))
* **invoices:** correct payment-check email template key so dunning email sends ([9a76333](https://github.com/filpgame/picpeak/commit/9a763337b658299aae0d7c985071c4a775000f99))
* **invoices:** correct payment-check email template key so dunning email sends ([3682de1](https://github.com/filpgame/picpeak/commit/3682de195b46eae692db3ff4a1476b00d3a6e216))
* **invoices:** show "Draft" on the invoice detail page for accumulator drafts ([ca09442](https://github.com/filpgame/picpeak/commit/ca0944293f66b6465a577340e63d592598915092))
* **invoices:** show sub-cent Rundung in the editor totals preview ([c2bc2b0](https://github.com/filpgame/picpeak/commit/c2bc2b098e6af3e984e5b06f42e21a8d9501349b))
...
* **messages:** dynamic addresses, branding accent, compose/sync, per-identity SMTP ([7cc1c59](https://github.com/filpgame/picpeak/commit/7cc1c596613c019db1e64fdc058a9e28bfd11fdc))
* **messages:** dynamic addresses, branding accent, compose/sync, per-identity SMTP ([f9c2b4e](https://github.com/filpgame/picpeak/commit/f9c2b4ed75b8a22182226a6328be0029c54d7bc4))
* **messages:** make the Messaging feature flag toggleable ([b96ad36](https://github.com/filpgame/picpeak/commit/b96ad36f5d65ca3774af4b6fa692b08819642de1))
* **messages:** PR [#769](https://github.com/filpgame/picpeak/issues/769) nits — server-side search, bare-email recipient, DE i18n ([1e08a4f](https://github.com/filpgame/picpeak/commit/1e08a4fb156d34ee8ddff69b0a7612001aa6d67e))
* **messages:** PR [#769](https://github.com/filpgame/picpeak/issues/769) review — escape reply sender (XSS), gate backend routes, exact customer match ([bb235e7](https://github.com/filpgame/picpeak/commit/bb235e72e58359f55f8aeccf2f22c671584fdbd7))
* **messages:** show only the mailbox local part in the sidebar (full … ([c622a35](https://github.com/filpgame/picpeak/commit/c622a35033d739bd04fa8a5388b2670769575bf4))
* **messages:** show only the mailbox local part in the sidebar (full address on hover) ([88fe9f9](https://github.com/filpgame/picpeak/commit/88fe9f984455ca1509f92a8b1d38342379acfd6c))
* **messages:** show the resolved customer's name in the doc-action modal ([2c5c1d5](https://github.com/filpgame/picpeak/commit/2c5c1d561bbe567b9d7615e7c2d071d08bb6d63c))
* mirror [#734](https://github.com/filpgame/picpeak/issues/734) onto decomposed files (PG NaN slideshow seed, SQLite bool renders) ([766351b](https://github.com/filpgame/picpeak/commit/766351b588bb9d3b270acb1b8c64bd6e242366c2))
* **og:** broaden social-crawler coverage (Bluesky Cardyb, WeChat-scraper, fediverse, etc.) ([a0a28a4](https://github.com/filpgame/picpeak/commit/a0a28a47777db9ca9e60a5134c8d86503c060e79))
* **og:** rich social previews for share-token + slideshow URLs ([#699](https://github.com/filpgame/picpeak/issues/699)) ([25bf7bb](https://github.com/filpgame/picpeak/commit/25bf7bb5239420da078749bac270196df6968581))
* **og:** rich social previews for share-token + slideshow URLs ([#699](https://github.com/filpgame/picpeak/issues/699)) ([1b8747d](https://github.com/filpgame/picpeak/commit/1b8747dc82763ba6b4da3a55045cab8740da2a13))
* **og:** route branded short URLs + slideshow links to OG, add Viber ([#699](https://github.com/filpgame/picpeak/issues/699)) ([0dffe0c](https://github.com/filpgame/picpeak/commit/0dffe0ce92339e0608b3ef660e84c31a62f4a98c))
* **og:** route branded short URLs + slideshow to OG handler, add Viber ([#699](https://github.com/filpgame/picpeak/issues/699)) ([a87ad77](https://github.com/filpgame/picpeak/commit/a87ad77d8d5215c88f5d95cc7aebaa1769938ec0))
* **pdf:** correct multi-page invoice/quote layout + drop IBAN dup under Swiss QR ([2205b0b](https://github.com/filpgame/picpeak/commit/2205b0bd687587ff2b54fbddb4770bf69a5ef3b2))
...
* **projects:** clickable milestones/feed, email rollup by customer, PG amount coercion ([c0b6d14](https://github.com/filpgame/picpeak/commit/c0b6d14d08755f23665eaa8d52dd6a250d6c9074))
...
* **projects:** make email preview fully read-only (no clickable links) ([fa622cf](https://github.com/filpgame/picpeak/commit/fa622cf2f87f447952b2e6e6e9d7fe60a1c14fb7))
* **projects:** make the whole email row clickable (opens preview) ([84b4a5f](https://github.com/filpgame/picpeak/commit/84b4a5f049a12bb22941dac733044d90a01fe052))
* **projects:** only link cockpit rows when the target feature is enabled ([2369323](https://github.com/filpgame/picpeak/commit/236932325971e23db17d6245d1ab2e9f2c1b4eec))
* **projects:** render email preview with its own brand colors, not forced light ([b9a9c01](https://github.com/filpgame/picpeak/commit/b9a9c018c0d2e0ff6c78ce0a1419ac28449043a4))
* **projects:** scope 'book to project' to the current customer ([89bfb6c](https://github.com/filpgame/picpeak/commit/89bfb6c5190ec0480168f9b59dc8ce5c2f104068))
* **projects:** scope email rollup to CRM types + re-render unstored previews ([f02fba6](https://github.com/filpgame/picpeak/commit/f02fba63325115fe416366c5d1c4f38900386cce))
* **projects:** use real events.edit permission for project writes ([f71243e](https://github.com/filpgame/picpeak/commit/f71243e388e12da840aa70193b4907af2866c039))
* **projects:** wrap long URLs in email preview (no horizontal scroll) ([0cc52f3](https://github.com/filpgame/picpeak/commit/0cc52f36938be2dc6c8a699afdc55d70831c02a9))
* **release:** target stable in release-please + undo bogus 2.7.0 bump ([274ef0c](https://github.com/filpgame/picpeak/commit/274ef0cd731765b057a5d62d5f41c14cb3a1564b))
* **release:** target stable in release-please.yml + undo the bogus 2.7.0 bump ([65ac6ed](https://github.com/filpgame/picpeak/commit/65ac6eddacb79857e9a9651d3c869e7bfdd92887))
* **reminders:** wrap is_active/is_archived wheres in formatBoolean ([b9d9138](https://github.com/filpgame/picpeak/commit/b9d91385b43de7ede508884f7cf78b5cf785f853))
* **security:** align password complexity setting key ([#35](https://github.com/filpgame/picpeak/issues/35)) ([a15c9a7](https://github.com/filpgame/picpeak/commit/a15c9a7a47c13b5f4b825d5fce0e138e9d55285d))
...
* **security:** close cross-event thumbnail leak, bulk-op ownership bypass, + hardening ([081f3ed](https://github.com/filpgame/picpeak/commit/081f3edcdffc65a77000cc638e364ea9dc03767f))
...
* **security:** cross-event thumbnail leak, bulk-op ownership bypass + auth hardening ([b732974](https://github.com/filpgame/picpeak/commit/b732974779803b67097c81ae6bce2de0f2910794))
* set GH_REPO in release-please auto-merge step ([d00d52a](https://github.com/filpgame/picpeak/commit/d00d52a2215dfcae34086cf3e10fe4da0aef09c9))
...
* **settings:** remove duplicate Mail import that broke the dev server ([5b535f8](https://github.com/filpgame/picpeak/commit/5b535f86580275eda768fa2d85a8c94bd701f832))
* **settings:** remove duplicate Mail import that crashes the dev server ([4aa6583](https://github.com/filpgame/picpeak/commit/4aa6583baef55e2c12e9cde7d391156436de518f))
* **setup:** address PR [#714](https://github.com/filpgame/picpeak/issues/714) review — password UX, script token, race, nits ([286975d](https://github.com/filpgame/picpeak/commit/286975dc52acf72809476e49ec0393021dd467cb))
* **setup:** keep the first-run wizard light regardless of dark mode ([d4b143f](https://github.com/filpgame/picpeak/commit/d4b143f313d00f2a30abcbc1a880c140d7455e7b))
* **setup:** match first-run logo size to the login page default ([3e69c5d](https://github.com/filpgame/picpeak/commit/3e69c5df3ffecc42663cba4ad7bf9f18795cedce))
...
* **test:** raise bootCrmDb beforeAll timeout on slideshow suites ([f4b6b89](https://github.com/filpgame/picpeak/commit/f4b6b8941a30a20615cc87627a0663ff6d03c932))
...
* **whatsnew:** decode HTML entities and trim em-dash detail in fallback bullets ([5582644](https://github.com/filpgame/picpeak/commit/5582644dc49330549be2a3a4cdd5b1ba0f21a294))
* **workflows:** backfill existing invoices + anchor dunning grace to due date when enabled ([#750](https://github.com/filpgame/picpeak/issues/750)) ([9596342](https://github.com/filpgame/picpeak/commit/9596342d6a9ef107193cfc123487a8061f4a91ca))
* **workflows:** backfill existing invoices + anchor grace to due date when dunning is enabled ([#750](https://github.com/filpgame/picpeak/issues/750)) ([2c7b351](https://github.com/filpgame/picpeak/commit/2c7b35145861557021482c0e92f573236ae2676e))
* **workflows:** close review blockers — prefetch-safe approvals + loud gate-edge failure ([98ab717](https://github.com/filpgame/picpeak/commit/98ab717043e3fdefac0934bf8f4621d523b15e9a))
* **workflows:** dark-mode canvas + readable nodes + structured config ([1734aba](https://github.com/filpgame/picpeak/commit/1734aba39c199c8dee1b69e9933ddf57579f9d50))
* **workflows:** defer quote.accepted/declined emit until the 15-min response window locks ([539a837](https://github.com/filpgame/picpeak/commit/539a83711d1996dc9c262365f2c511e7bc445add))
* **workflows:** harden graph validation + refuse enabling unimplemented flows ([d927464](https://github.com/filpgame/picpeak/commit/d927464778272bd862aa01903179672f4d47368a))
* **workflows:** held booking invoices are 'scheduled', not 'pending_delivery' — so send_document can issue them ([882cfc0](https://github.com/filpgame/picpeak/commit/882cfc0661b02602bae91b928a46ceea754f7f29))
* **workflows:** make the dashboard pending-approvals card items clickable too ([6e20d58](https://github.com/filpgame/picpeak/commit/6e20d58487c5e20b08e1d1b4ddd4e76f9e922a79))
* **workflows:** matchFilter strict equality + accurate comment ([dee8d40](https://github.com/filpgame/picpeak/commit/dee8d40bb3235a908bba514a97a62d3a91a6e131))
* **workflows:** Postgres-safe id capture on workflow inserts ([cede885](https://github.com/filpgame/picpeak/commit/cede885b04854fd667f65a19697505c0a7c52739))
* **workflows:** scope dunning backfill to its own flow via targetWorkflowId ([da3a77d](https://github.com/filpgame/picpeak/commit/da3a77dac40a892158167aec939a1458d488a951))
* **workflows:** ship built-ins disabled for first beta + enabled-based mutex + admin sentinel ([5893ecb](https://github.com/filpgame/picpeak/commit/5893ecb27a0365a79ec04336c5a122b31d31db0e))
* **workflows:** wire a real, SSRF-guarded webhook action (was a silent no-op) ([af7eea8](https://github.com/filpgame/picpeak/commit/af7eea8b43e37905a79138bcde4b1026dea13050))
...
* branch model + migration-to-org guide + PR template ([166ef47](https://github.com/filpgame/picpeak/commit/166ef47611a248c4d517e26d390d87d21f077ca1))
* branch model + migration-to-org guide + PR-template target hint ([d606fcd](https://github.com/filpgame/picpeak/commit/d606fcd5a425fed3c968ec06b071a386bf558c28))
* prominent migration banner at the top of README ([14bd3e1](https://github.com/filpgame/picpeak/commit/14bd3e1a6c6cf74378d6f316024584d8941cbcd5))
* prominent migration banner at the top of README ([#669](https://github.com/filpgame/picpeak/issues/669)) ([5839bba](https://github.com/filpgame/picpeak/commit/5839bba72a56cc29077f63f7daa038995fb09dfb))
...
* **readme:** add Pixieset to comparison + customer-accounts/CRM/accounting rows ([721f440](https://github.com/filpgame/picpeak/commit/721f440fa6e810e26ec92d89d14497bd946bcdef))
* **readme:** clarify comparison footnotes — $0 cost caveat + Pixieset video cap ([b043963](https://github.com/filpgame/picpeak/commit/b0439638bddba819b58d375c0f42cd4df3a837b4))
* **readme:** credit [@the-luap](https://github.com/the-luap) as creator/lead maintainer ([3528f6b](https://github.com/filpgame/picpeak/commit/3528f6b8b7e2b537b111f7787d48459a976ef744))
* **readme:** credit [@the-luap](https://github.com/the-luap) as creator/lead maintainer ([748238e](https://github.com/filpgame/picpeak/commit/748238e8caf198e3899954804e61a2e179058957))
* **releasing:** align stable version to main on promote (Option A) ([df5aeab](https://github.com/filpgame/picpeak/commit/df5aeaba416726cc0123f32ddf88e4a30dc28908))
* **releasing:** align stable version to main on promote (Option A) ([5dea0c9](https://github.com/filpgame/picpeak/commit/5dea0c969558f50833973ff742257780f5842612))
* require screenshots for UI changes in PRs ([f5b4aa7](https://github.com/filpgame/picpeak/commit/f5b4aa7a5bc321ffbd33f1c1b92003435a7ee842))
* require screenshots for UI changes in PRs ([8ca7477](https://github.com/filpgame/picpeak/commit/8ca74776f4d3f7be930a713afe4ac4de594adedd))
